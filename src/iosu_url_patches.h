...
static const URL_Patch url_patches[] = {
        ...
        {0xE2299990, "boss.nicochristmann.net"},
        ...
        {0xE229B1F4, "https://boss.nicochristmann.net/p01/tasksheet/%s/%s/%s/%s?c=%s&l=%s"},
        {0xE229B238, "https://boss.nicochristmann.net/p01/tasksheet/%s/%s/%s?c=%s&l=%s"},
        ...
        //nim-boss .bss
        {0xE24B8A24, "https://boss.nicochristmann.net/p01/policylist/1/1/UNK"},
        {0xE31930D4, "https://act.nicochristmann.net:6666/v1/api/"},
